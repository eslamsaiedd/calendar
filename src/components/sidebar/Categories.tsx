export function Categories() {
  return (
    <>
      <div className=" dark:text-white border-t border-[var(--updated-border-light)] dark:border-[var(--border)] mt-2 pt-1">
        ...
        <div className=" w-full flex items-center flex-wrap gap-1.5">
          {["Work", "Personal", "Holidays", "Travel"].map((label) => (
            <button
              key={label}
              className={`p-1.5 rounded-2xl text-sm hover:bg-[var(--bg-primary-light)] dark:hover:bg-gray-700 transition
