    ...
    <nav className="w-full sticky top-0 border-b border-[var(--updated-border-light)] dark:border-[var(--border)] z-50 bg-white dark:bg-[var(--bg-primary)] h-16 flex items-center justify-between px-6">
      ...
      <div className="flex gap-1.5 items-center">
        {user ? (
            ...
            <NavLink to="/login" className="px-4 py-1.5 hover:cursor-pointer text-[var(--text-primary-light)] dark:text-[var(--text-primary-dark)] rounded-lg w-fit h-fit bg-[linear-gradient(90deg,#7C3AED,#A855F7)] transition ">
              Login
            </NavLink>
        )}
